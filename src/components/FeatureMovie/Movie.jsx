  ...
  return (
    <>
      ...
      <div className="absolute bottom-[10%] left-8 w-1/2 sm:w-1/3">
        ...
        <div className="mt-4">
          <button className="mr-1 rounded bg-white px-4 py-2 text-10 text-black lg:text-lg">
            <FontAwesomeIcon icon={faPlay} className="mr-1" />
            Trailer
          </button>
          <button className="rounded bg-slate-300/35 px-4 py-2 text-10 hover:bg-slate-400/35 lg:text-lg">
            View Detail
          </button>
        </div>
      </div>
